...
def get_3D_model_from_scene(silent, scene_state, min_conf_thr=2, as_pointcloud=False, mask_sky=False,
    ...
    return _convert_scene_output_to_glb(outfile, rgbimg, pts3d, msk, silent=silent)
...
def main_demo(tmpdirname, model, device, image_size, server_name, server_port, silent=False,
    ...
    with get_context(gradio_delete_cache) as demo:
        ...
        with gradio.Column():
            ...
            download_ply_btn = gradio.Button("Get ply")
            download_ply_btn_hidden = gradio.DownloadButton(visible=False, elem_id="download_ply_btn_hidden")
            download_ply_btn.click(fn= lambda : "scene.ply", inputs=None, outputs=[download_ply_btn_hidden]).then(fn=None, inputs=None, outputs=None, js="() => document.querySelector('#download_ply_btn_hidden').click()")
